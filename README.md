...
```
cd existing_repo
git remote add origin https://gitlab.com/hardianamurnisafitri4/SIP UJIAN.git
git branch -M main
...
-   [ ] [Set up project integrations](https://gitlab.com/hardianamurnisafitri4/SIP UJIAN/-/settings/integrations)
