                        ...
                        <div class="col-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                <a class="list-group-item list-group-item-action active" id="list-home-list"
                                    data-toggle="list" href="#list-home" role="tab"><i
                                        class="fas fa-user"></i>&nbsp;&nbsp;Profil</a>
                                <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list"
                                    href="#list-profile" role="tab"><i class="fas fa-key"></i>&nbsp;&nbsp;Kata Sandi</a>
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="list-home" role="tabpanel"
                                    ...
                                    <form action="{{ route('update.profil', ['id' => $user->id_users]) }}" method="POST">
                                        ...
                                        is-invalid
                                        @enderror"
                                                    id="nama" value="{{ Auth::user()->detail->nama }}"
                                        ...
                                        is-invalid
                                        @enderror"
                                                id="email" value="{{ $user->email }}" placeholder="Masukan email ">
                                            @error('email')
                                                <div class='invalid-feedback'>
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="tab-pane fade" id="list-profile" role="tabpanel"
                                    ...
                                    <div class="alert alert-primary alert-dismissible show fade alert-has-icon">
                                        ...
                                        <div class="alert-body">
                                            ...
                                            Masukan minimal 8 karakter dan gunakan kombinasi huruf kapital, huruf kecil,
                                            angka, dan simbol.
                                        </div>
                                    </div>
                                    <form action="{{ route('update.password', ['id' => $user->id_users]) }}" method="POST">
                                        ...
                                        is-invalid
                                        @enderror"
                                                id="password_lama" autofocus='true' placeholder="Masukan kata sandi lama">
                                            @error('password_lama')
                                                <div class='invalid-feedback'>
                                                    {{ $message }}
                                                </div>
                                        ...
                                        is-invalid
                                        @enderror"
                                                id="password_baru" value="{{ old('password_baru') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password_konfirmasi"
                                                class="form-control @error('password_konfirmasi')
                                        is-invalid
                                        @enderror"
                                                id="password_konfirmasi" value="{{ old('password_konfirmasi') }}"
                                                placeholder="Masukan kata sandi baru">
