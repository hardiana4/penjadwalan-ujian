...
@section('title', 'Matakuliah Prodi D4')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Ubah Matakuliah Prodi D4</h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update.trmatakuliahD4', ['id' => $tr_matakuliah->id]) }}" method="POST"
                        ...
                        <div class="card-footer">
                            <div class="row float-right" style="margin: 0px 0px 25px;">
                                <a href="{{ route('trmatakuliahD4') }}" type="button"
