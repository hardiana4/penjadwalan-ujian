...
@section('title', 'Tambah Penjadwalan Matakuliah Prodi D4')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Penjadwalan Matakuliah Prodi D4</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('/beranda') }}">Beranda</a></div>
                    <div class="breadcrumb-item">Penjadwalan Matakuliah</div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Penjadwalan Matakuliah</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('create.trmatakuliahD4') }}" method="POST"
