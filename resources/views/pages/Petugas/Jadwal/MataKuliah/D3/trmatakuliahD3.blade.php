...
@section('title', 'Penjadwalan Mata Kuliah Prodi D3')
...
@section('main')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Penjadwalan Mata Kuliah Prodi D3</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Daftar Penjadwalan Mata Kuliah</h4>
                            <div class="col box-header text-right">
                                <a href="{{ route('tambah.trmatakuliahD3') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i &nbsp> Tambah</a>
                                <a href="{{ route('trmatakuliahD3') }}" id="deletePMatkul"
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <a
                                                            href="{{ route('ubah.trmatakuliahD3', ['id' => $m->id_trmatakuliah]) }}"class="btn btn-warning">
    ...
    @foreach ($tr_matakuliah as $m)
        @include('pages.petugas.jadwal.matakuliah.D3.hapus_trmatakuliahD3')
    @endforeach
@endsection
