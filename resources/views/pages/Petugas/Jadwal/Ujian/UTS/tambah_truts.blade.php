...
@section('title', 'Tambah Penjadwalan UTS')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('/penjadwalan-ujian-tengah-semester') }}">Penjadwalan Ujian</a></div>
                    <div class="breadcrumb-item">Tambah Penjadwalan UTS</div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Penjadwalan UTS</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('create.trUTS') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-footer">
                                    <div class="row float-right" style="margin: 0px 0px 25px;">
                                        <a href="{{ route('trUTS') }}" type="button"
