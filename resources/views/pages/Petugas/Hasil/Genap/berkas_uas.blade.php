<!-- Modal -->
<div class="modal fade" id="berkas_uas" role="dialog" aria-labelledby="berkas_uas" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="hapus">Cetak Daftar Pengambilan Berkas UAS</h5>
