...
@section('title', 'Cetak Semester Ganjil')
...
@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Cetak Berkas Semester Ganjil</h1>
    ...
    @include('pages.petugas.hasil.ganjil.berkas_uts')
    @include('pages.petugas.hasil.ganjil.berkas_uas')
    @include('pages.petugas.hasil.ganjil.jadwal_uts')
    @include('pages.petugas.hasil.ganjil.jadwal_uas')
@endsection
