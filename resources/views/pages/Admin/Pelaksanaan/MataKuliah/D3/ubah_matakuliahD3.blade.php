...
@section('title', 'Ubah Mata Kuliah Prodi D3')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Ubah Mata Kuliah Prodi D3</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('/beranda') }}">Beranda</a></div>
                    <div class="breadcrumb-item"><a href="{{ url('/matakuliah-D3') }}">Mata Kuliah Prodi D3</a></div>
                    <div class="breadcrumb-item">Ubah Mata Kuliah Prodi D3</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Ubah Mata Kuliah Prodi D3</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('update.matakuliahD3', ['id' => $matakuliah->id_matakuliah]) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($prodi as $key => $value)
                                                    <option value="{{ $key }}" {{$matakuliah->id_prodi == $key ? 'selected' : ''}}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_prodi')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off"  name="matakuliah" placeholder="Masukan nama matakuliah"
                                        class="form-control @error('matakuliah') is-invalid @enderror nonAngkaInput" value=" {{$matakuliah->matakuliah}}">
                                    @error('matakuliah')
                                        <div class='invalid-feedback'>
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="card-footer">
                            <div class="row float-right" style="margin: 0px 0px 25px;">
                                <a href="{{ route('matakuliah.D3') }}" type="button"
