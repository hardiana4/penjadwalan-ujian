...
@section('title', 'Matakuliah Prodi D3')
...
@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Mata Kuliah Prodi D3</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ url('/beranda') }}">Beranda</a></div>
                    <div class="breadcrumb-item">Mata Kuliah Prodi D3</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col box-header text-right">
                                <a href="{{ route('tambah.matakuliahD3') }}" class="btn btn-primary"><i
                                ...
                                <a href="{{ route('matakuliah.D3') }}" id="deleteMtk" class="btn btn-danger dis disabled"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <a
                                                            href="{{ route('ubah.matakuliahD3', ['id' => $m->id_matakuliah]) }}"class="btn btn-warning">
    ...
    @foreach ($matakuliah as $m)
        @include('pages.admin.pelaksanaan.matakuliah.D3.hapus_matakuliahD3')
        @endforeach
        @include('pages.admin.pelaksanaan.matakuliah.D3.importMtkD3')
@endsection
