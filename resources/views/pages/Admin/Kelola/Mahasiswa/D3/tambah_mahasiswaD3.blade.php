...
@section('title', 'Tambah Mahasiswa Prodi D3')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('/mahasiswa-D3') }}">Mahasiswa Prodi D3</a></div>
                    <div class="breadcrumb-item">Tambah Mahasiswa Prodi D3</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tambah Mahasiswa Prodi D3</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('create.mahasiswaD3') }}" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-4">
                                        @csrf
                        ...
                        <div class="card-footer">
                            <div class="row float-right" style="margin: 0px 0px 25px;">
                                <a href="{{ route('mahasiswa.D3') }}" type="button"
                ...
                if (IDprodi) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('select[name="id_pengawas"]').empty();
                            $.each(data, function(key, value) {
                                $('select[name="id_pengawas"]').append('<option value="' +
                                    key + '">' + value + '</option>');
                            });
                        }
                    });
