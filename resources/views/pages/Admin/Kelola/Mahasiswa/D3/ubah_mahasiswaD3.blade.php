...
@section('title', 'Ubah Mahasiswa Prodi D3')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Ubah Mahasiswa Prodi D3</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Ubah Mahasiswa Prodi D3</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('update.mahasiswaD3', ['id' => $mahasiswa->id_mahasiswa]) }}" method="POST"
