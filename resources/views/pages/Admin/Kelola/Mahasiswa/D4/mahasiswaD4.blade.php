...
@section('title', 'Mahasiswa Prodi D4')
...
@section('main')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Mahasiswa Prodi D4</div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col box-header text-right">
                                <a href="{{ route('tambah.mahasiswaD4') }}" class="btn btn-primary"><i
                                ...
                                <a href="{{ route('mahasiswa.D4') }}" id="deleteMhs" class="btn btn-danger dis disabled"><i
                                        class="fa fa-dumpster-fire"></i &nbsp> Hapus Semua</a>
                                <a href="{{ route('mahasiswa.D4') }}" id="push" class="btn btn-dark dis disabled"><i
                                                ...
                                                <td>
                                                    <div class="dropdown d-inline">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon" href="{{ route('ubah.mahasiswaD4', ['id' => $m->id_mahasiswa]) }}"><i class="fas fa-pen"></i> Ubah</a>
                                                            <a class="dropdown-item has-icon" href="" data-toggle="modal" data-target="#hapus_mahasiswa_{{ $m->id_mahasiswa }}"><i class="fas fa-trash"></i> Hapus</a>
                                                            @if ($m->status == '0')
                                                            <a class="dropdown-item has-icon" href="" data-toggle="modal" data-target="#detail_{{ $m->id_mahasiswa }}"><i class="fas fa-info"></i> Detail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </td>
    ...
    @foreach ($mahasiswa as $m)
        @include('pages.admin.kelola.mahasiswa.D4.hapus_mahasiswaD4')
        @include('pages.admin.kelola.mahasiswa.detail')
        @endforeach
        @include('pages.admin.kelola.mahasiswa.importMhsD4')
@endsection
