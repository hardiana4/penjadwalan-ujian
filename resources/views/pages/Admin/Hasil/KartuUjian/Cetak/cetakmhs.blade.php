            ...
            <table class="tabel">
                <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="line-height: 0.6; padding-right: 5px;">
                                    <center>
                                        ...
                                        <span style="font-size: 6pt;">Jalan Dr.Soetomo No.1, Sidakaya-CILACAP 53212 Jawa
                                            Tengah</span><br>
                                        <span style="font-size: 6pt;">Telepon: (0282) 537992, Fax: (0282)
                                            537992</span><br>
                                        <span style="font-size: 6pt;">www.pnc.acpengawas. Email: sekretariat@pnc.ac.id</span>
                                    </center>
                                </td>
                            </tr>
                        </table>
                        ...
                        <center class="text">
                            <span style="font-size: 9pt;"><strong>Kartu Peserta
                                @if ($jadwal->jenis === "UTS")
                                        ...
                                        @if ($mhs->semester === "I (Satu)" || $mhs->semester === "III (Tiga)" || $mhs->semester === "V (Lima)" || $mhs->semester === "VII (Tujuh)")
                                            Ganjil
                                        @else
                                            Genap
                                        @endif
                                        @else
                                        Ujian Akhir Semester @if ($mhs->semester === "I (Satu)" || $mhs->semester === "III (Tiga)" || $mhs->semester === "V (Lima)" || $mhs->semester === "VII (Tujuh)")
                                            Ganjil
                                        @else
                                            Genap
                                        @endif
                                    @endif
                                    <br>Tahun Akademik {{ $tapel->tahun_pelajaran }}</strong></span>
                        </center>
                        <table style="padding: 10px 10px 2px 10px;">
                            <tr class="text">
                                ...
                                <td style="border-bottom: 1px solid; padding-bottom: 2px;" width="240px;">
                                    {{ strtoupper($mhs->nama_mahasiswa) }} </td>
                            </tr>
                            <tr class="text">
                                <td><b>NPM</b></td>
                                <td>:</td>
                                <td style="border-bottom: 1px solid; padding-bottom: 2px;"> {{ $mhs->npm }} </td>
                            </tr>
                            <tr class="text">
                                <td><b>Prodi</b></td>
                                <td>:</td>
                                <td style="border-bottom: 1px solid; padding-bottom: 2px; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;"> {{ $mhs->prodi->prodi }}
                                </td>
                            </tr>
                            <tr class="text">
                                <td><b>Semester</b></td>
                    ...
                    <td class="tabel" style="width: 53%;">
                        <center>
                            <span class="text">
                                @if ($jadwal->jenis === "UTS")
                                        ...
                                        @endif</b></span>
                                        @else
                                         <span><b>Jadwal Ujian Akhir Semester (UAS) @if ($mhs->semester === "I (Satu)" || $mhs->semester === "III (Tiga)" || $mhs->semester === "V (Lima)" || $mhs->semester === "VII (Tujuh)")
                                            Ganjil
                                        @else
                                            Genap
                                        @endif</b></span>
                        ...
                        <br>
                        <br>
                        <p size="1" class="text" style="font-size: 8px; margin-top: 0px; padding: 5px;">
                                <b>Ketentuan :</b>
                            </p>
                            <p size="1" class="text" style="font-size: 8px; margin-top: 0px; padding: 5px;">-
                                Selama
                                mengikuti {{ $jadwal->jenis }} kartu ini harus dibawa</p>
                            <p size="1" class="text" style="font-size: 8px; margin-top: 0px; padding: 5px;">-
                                Selama {{ $jadwal->jenis }} berlangsung mahasiswa hadir 10 menit sebelum ujian dimulai</p>
                            @if($mhs->status === "0")
                            <p size="1" class="text" style="font-size: 8px; margin-top: 0px; padding: 5px;">- Mahasiswa ini belum melunasi pembayaran</p>
                            @endif
                    </td>
                </tr>
        </div>
