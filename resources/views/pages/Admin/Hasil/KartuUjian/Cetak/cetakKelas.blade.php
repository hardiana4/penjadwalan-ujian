                        ...
                        <tr>
                            <td class="tabel " style="width: 47%">
                                <table style="margin: 3px;">
                                    <tr>
                                        ...
                                        <td class="text-right" style="line-height: 0.6; padding-right: 5px;">
                                            <center>
                                                <span style="font-size: 6pt;">KEMENTERIAN PENDIDIKAN,
                                                    KEBUDAYAAN,</span><br>
                                                <span style="font-size: 6pt;">RISET, DAN TEKNOLOGI</span><br>
                                                <span style="font-size: 6pt;"><b>POLITEKNIK NEGERI
                                                        CILACAP</b></span><br>
                                                <span style="font-size: 6pt;">Jalan Dr.Soetomo No.1, Sidakaya-CILACAP
                                                    53212 Jawa
                                                    Tengah</span><br>
                                ...
                                <span class="small-text"
                                    style="float: right; margin: 5px 20px;">{{ $jadwal->kode }}</span>
                                <br>
                                <center class="text">
                                ...
                                <table style="padding: 10px 10px 2px 10px;">
                                    ...
                                    <tr class="text">
                                        <td><b>Prodi</b></td>
                                        <td>:</td>
                                        <td style="border-bottom: 1px solid; padding-bottom: 2px; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;">
                                            {{ $m->prodi->prodi }}
                                        </td>
                                    </tr>
                                    <tr class="text">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($matkul as $index => $m)
                                                @if ($m->tgl_ujian !== $prevTanggalUjian)
                                                    <tr>
                                                        <td class="tabel jadwal-text text-center">{{ $m->hari }}
                                                        </td>
                                                        <td class="tabel jadwal-text text-center">{{ $m->sesi->sesi }}
                                                        </td>
                                                    ...
                                                    @if ($index + 1 < count($matkul) && $m->tgl_ujian !== $matkul[$index + 1]->tgl_ujian)
                                                        <tr>
                                                            <td class="tabel jadwal-text text-center">
                                                                {{ $m->tgl_ujian }}</td>
