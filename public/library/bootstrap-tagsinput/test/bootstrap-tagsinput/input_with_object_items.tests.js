describe("bootstrap-tagsinput", function() {
  ...
  describe("with objects as items", function() {
    testTagsInput('<input type="text" autocomplete="off"  />', function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { itemValue: function(item) { return item.value; } }, function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { itemValue: 'value' }, function() {
      describe("adding an item", function() {
        var item;
        beforeEach(function() {
          item = { value: 1 };
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { itemValue: function(item) { return item.value; }, itemText: function(item) { return item.text; } }, function() {
      describe("adding an item", function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { itemValue: function(item) { return item.value; }, itemText: function(item) { return item.text; }, itemTitle: function(item) { return item.title; } }, function() {
