describe("bootstrap-tagsinput", function() {
  ...
  describe("with strings as items", function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { trimValue: true }, function(){
    ...
    testTagsInput('<input type="text" autocomplete="off"  value="some,tags" />', function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  value="some,tag"/>', { maxTags: 2 }, function() {
    ...
    testTagsInput('<input type="text" autocomplete="off"  />', { confirmKeys: [9] }, function() {
